...
class WS_TFA_Net(nn.Module):
    ...
    def _flatten_and_concat_features(self, fpn_features: Dict[str, torch.Tensor]) -> torch.Tensor:
        """
        Flattens multi-scale spatial features into a 1D sequence for the Transformer.
        """
        # We only use P2_prime, P3, P4, P5
        ...
        # Resulting shape: [B, Seq_Len_Total, C]
    ...
    def forward(self, x: torch.Tensor, return_features: bool = False) -> Dict[str, torch.Tensor]:
        ...
        seq_features = self._flatten_and_concat_features(p_features)
        
        # 4. Sparse MIL Head Predictions
        head_outputs = self.mil_head(seq_features)
